...
const SETUP_STEPS: SetupStep[] = [
  {
    ...
    description: "Install required dependencies on your machine.",
    icon: Download,
    commands: {
      linux: [
      ...
      "linux-rhel": [
        "sudo yum update -y",
        "sudo yum install -y curl wget git docker docker-compose",
        "sudo systemctl enable docker && sudo systemctl start docker",
      ],
      macos: [
    ...
    tip: "Make sure Docker is running before continuing.",
  },
  {
    title: "Download OpenClaw Agent",
    description: "Download and extract the OpenClaw node agent.",
    icon: Terminal,
    commands: {
      linux: [
        "curl -sSL https://get.openclaw.ai/agent | bash",
        "cd openclaw-agent",
      ],
      "linux-rhel": [
        "curl -sSL https://get.openclaw.ai/agent | bash",
      ...
      windows: [
        "Invoke-WebRequest -Uri https://get.openclaw.ai/agent.ps1 -OutFile install.ps1",
        "powershell -ExecutionPolicy Bypass -File install.ps1",
        "cd openclaw-agent",
      ],
    },
    tip: "The installer will download the latest stable version automatically.",
  },
  {
    title: "Configure Connection",
    description: "Set your gateway URL and pairing code so the node connects to your instance.",
    icon: Wifi,
    commands: {
      linux: [
        "# Edit the config file with your instance details",
        'echo \'GATEWAY_URL=https://your-instance.openclaw.ai\' > .env',
        'echo \'PAIRING_CODE=<your-pairing-code>\' >> .env',
      ],
      "linux-rhel": [
        'echo \'GATEWAY_URL=https://your-instance.openclaw.ai\' > .env',
        'echo \'PAIRING_CODE=<your-pairing-code>\' >> .env',
      ...
      windows: [
        'Set-Content .env "GATEWAY_URL=https://your-instance.openclaw.ai"',
        'Add-Content .env "PAIRING_CODE=<your-pairing-code>"',
      ],
    },
    tip: "You can get a pairing code from the Nodes page in the dashboard.",
  },
  {
    ...
    tip: "You should see 'Connected to gateway' in the logs within 30 seconds.",
  },
  {
    title: "Approve Node",
    description: "Go to the Nodes page and approve the new node that appears in pending status.",
    icon: Shield,
    commands: {
