...
const SETUP_STEPS: SetupStep[] = [
  ...
  },
  {
    ...
    tip: "Replace <gateway-ip> with the IP of your primary machine (check 'openclaw status' on the gateway — look for the IP next to the machine name). Replace <your-gateway-token> with the token from Step 3.",
  },
  {
