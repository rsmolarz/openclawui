...
const SETUP_STEPS: SetupStep[] = [
  {
    ...
    commands: {
      ...
      windows: [
        "# Windows requires WSL2 (recommended) or PowerShell",
        "",
        "# WSL2 (recommended):",
        "wsl --install",
    ...
    tip: "Use --no-onboard to skip the full gateway setup. Nodes are companion devices — they connect to your existing gateway, so they don't need their own API keys or channels.",
  },
  {
