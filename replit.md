...
- **New Pages**:
  ...
  - **Marketplace** (`/marketplace`): Skill plugin catalog with install/uninstall. Backend: `GET /api/marketplace/plugins`, `POST /api/marketplace/plugins/:name/install`, `POST /api/marketplace/plugins/:name/uninstall`.
