...
- **Node Skill Content**: `getNodeSkillContent()` function in routes.ts provides full SKILL.md and handler.py templates for 8 deployable skills (system-agent, windows-admin, ui-automation, screen-vision, homeassistant-agent, webhook-agent, keyboard-agent, process-manager).
